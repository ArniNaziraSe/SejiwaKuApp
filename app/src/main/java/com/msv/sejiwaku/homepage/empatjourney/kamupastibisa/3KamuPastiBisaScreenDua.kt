...
fun KamuPastiBisaScreenDua(
    ...
    Column(
        ...
        BagianTombolMenerimaDiriPt1(
            ...
            waktunya = "3 menit",
            onClick = {
                navController.navigate(BottonBarScreen.DetailCurhatPadaDiriSendiri.route){
                    popUpTo(BottonBarScreen.DetailKamuPastiBisaDua.route){
                        inclusive = true
                    }
                }
                      },
...
private fun PreviewMenerimaDiriScreen() {
    KamuPastiBisaScreenDua(navController = rememberNavController())
}