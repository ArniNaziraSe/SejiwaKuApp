package com.msv.sejiwaku.homepage.empatjourney.menerimadiri.hirupnapasperlahan
...
fun HirupNafasPerlahan(
    ...
    Column(
        ...
        Column(
            ...
            Surface(
                onClick = {
                    navController.navigate(BottonBarScreen.DetailMenerimaDiriScreenDua.route){
                        popUpTo(BottonBarScreen.DetailHirupNapasPerlahan.route){
                            inclusive = true
                        }
                    }
                }
