package com.msv.sejiwaku.homepage.empatjourney.menerimadiri.dengarkanmusiktenang.musik
...
fun MusikStatu(
    ...
    val dataStore = DataStoreJourneySatu(context)
                ...
                Image(painter = painterResource(id = R.drawable.nextdua), contentDescription = "tombol next", modifier = Modifier
                    ...
                    .clickable {
                        ...
                        navController.navigate(BottonBarScreen.DetailMenerimaDiriScreenTiga.route){
                            popUpTo(BottonBarScreen.DetailMusikSatu.route){
                                inclusive = true
                            }
                        }
                    }
