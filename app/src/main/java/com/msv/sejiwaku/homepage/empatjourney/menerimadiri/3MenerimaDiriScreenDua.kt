package com.msv.sejiwaku.homepage.empatjourney.menerimadiri
...
import com.msv.sejiwaku.sda.navigator.jalanpindah.BottonBarScreen
    ...
    fun MenerimaDiriScreenDua(
        ...
        Column(
            ...
            BagianTombolMenerimaDiriPt1(
                ...
                waktunya = "3 menit",
                onClick = {
                    navController.navigate(BottonBarScreen.DetailDengarkanMusikTenang.route){
                        popUpTo(BottonBarScreen.DetailMenerimaDiriScreenDua.route){
                            inclusive = true
                        }
                    }
                          },
    ...
    MenerimaDiriScreenDua(navController = rememberNavController())
}